    ...
    <div style={{ backgroundColor: "rgba(0, 0, 0, 0)" }}>
      <div className="container px-5 py-24 mx-auto" style={{ cursor: "auto" }}>
        <div className="flex flex-wrap mx-auto lg:w-4/5">
          ...
          />
          <div
            className="w-full mt-6 lg:w-1/2 lg:pl-10 lg:py-6 lg:mt-0"
            style={{ cursor: "auto" }}
          >
            <h2
              className="text-sm tracking-widest text-gray-500 title-font"
              style={{ cursor: "auto" }}
            >
              ON SALE
            </h2>
            <h1
              className="mb-1 text-3xl font-medium text-gray-900 title-font"
              style={{ cursor: "auto" }}
            >
              Blue Dress v2
            </h1>
            <div className="flex mb-4">
              <span className="flex items-center">
                ...
                <span className="ml-3 text-gray-600">20 Reviews</span>
              </span>
